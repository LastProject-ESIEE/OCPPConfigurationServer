                ...
                <Box height={"88vh"} overflow={"auto"} marginTop={0}>
                    <List style={{overflow: "auto", paddingTop: 0}}>
                        {notificationList.map((notif,index) => {
                            ...
                            return (
                                <ListItem key={"notif-list-item-" + index} style={{paddingLeft: 5, paddingTop: 0, paddingBottom: 0, paddingRight: 5}}>
                                    <ListItemText title={notif.date + " - " + notif.title + "\n" + notif.content}  style={{/*width: 400*/}} >
                                        <Box bgcolor={backgroundColor} borderRadius={2} paddingLeft={1}>
                                            <Grid container flexDirection={"column"}>
                                                <Grid item xs={12}>
                                                    <Typography noWrap variant="h6">{notif.date + " - " + notif.title}</Typography>
                                                </Grid>
