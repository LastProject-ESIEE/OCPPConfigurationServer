...
public interface OcppObserver {
  ...
  static OcppObserver instantiateFromVersion(OcppVersion ocppVersion,
    ...
    return switch (ocppVersion) {
      case V1_6 -> new Ocpp16ConfigurationObserver(ocppMessageSender,
                      chargepointRepository, firmwareRepository, statusRepository);
      case V2 -> throw new AssertionError("Still not implemented");
    };
  }
