...
INSERT INTO chargepoint (serial_number_chargepoint, type, constructor, client_id, server_address, configuration, id_status, id_firmware) VALUES ('alfen_serial_number', 'mega-type', 'alfen', 'COMMUNIAU_1', 'localhost', '{json}', 1, 1);
INSERT INTO chargepoint (serial_number_chargepoint, type, constructor, client_id, server_address, configuration, id_status, id_firmware) VALUES ('alfen_serial_number2', 'mega-type', 'alfen', 'COSTANDINI_1', 'localhost', '{json}', 2, 2);